...
export const metadata: Metadata = { metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL ?? "http://localhost:3000"), title:{ default:"EVENT MANAGEMENT SYSTEM", template:"%s | EVENT MANAGEMENT SYSTEM" }, description:"チケット確保から実来場までを追跡するイベント運営管理システム", applicationName:"EVENT MANAGEMENT SYSTEM", manifest:"/manifest.webmanifest", appleWebApp:{ capable:true, statusBarStyle:"default", title:"Event Manager" } };
